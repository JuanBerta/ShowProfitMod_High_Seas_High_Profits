    ...
    public class ProfitTextModClass : MelonMod
    {
        ...
        public static class GeneralSettings_ProfitUI_Patch
        {
            public static void Postfix(GeneralSettingsWindow __instance)
            {
                ...
                GameObject.Destroy(label.GetComponent<zip.lexy.tgame.localization.LocalizeField>());
        ...
        public static class Patch_TradeWindow_Start
        {
            public static void Postfix(TradeWindow __instance)
            {
                ...
                ProfitTextMod.GetDisplayModeClass.GetDisplayModeClass.GetDisplayMode();
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(window);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(shipCargo);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(view);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(trade);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(goods);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(tradeToShipHeaderColors);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(tradeToWarehouseColors);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(separatorTopSell);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(separatorBottomSell);
                ...
                CheckIfObjExistsClass.CheckIfObjExistsClass.CheckIfObjExists(destinationObj);
